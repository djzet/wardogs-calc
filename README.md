...
- Интерактивная карта с тайловым зумом и pan
- Дистанция, азимут, elevation (mils)
- Миномёт (700 м) и артиллерия (2.5 км)
- Share-ссылки, автосохранение, темы
- 9 языков, мобильная версия

Полный список — в [docs/features.md](docs/features.md).

## Документация

- [development.md](docs/development.md) — запуск и архитектура
- [features.md](docs/features.md) — функции и данные оружия
- [localization.md](docs/localization.md) — переводы
