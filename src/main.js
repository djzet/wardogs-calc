...
// ═══════════════════════════════════════════════════════════
import '../js/map/spatial.js';      /** Пространственный индекс вышек (grid-based O(1)) */
...
// ═══════════════════════════════════════════════════════════
//  Локализация: инлайненные данные + i18n менеджер
// ═══════════════════════════════════════════════════════════
import '../js/locale-data.js';     /** Инлайненные переводы (virtual:locale-data) — build-only */
