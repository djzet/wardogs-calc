# WARDOGS — Calculadora de Mortero y Artillería
...
Lista completa — en [docs/features.md](docs/features.md).

## Documentación (RU)

- [development.md](docs/development.md) — ejecución y arquitectura
- [features.md](docs/features.md) — funciones y datos de armas
- [localization.md](docs/localization.md) — traducciones
