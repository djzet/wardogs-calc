...
window.LocaleManager = (function () {
    ...
    const FALLBACK_TRANSLATIONS = {
        ru: {
            ...
            faq2a: 'Максимальная дальность <strong>миномёта в WARDOGS</strong> составляет <strong>700 метров</strong>. Для целей дальше 700 м используйте <strong>артиллерию</strong>, которая стреляет на расстояние <strong>более 2 км</strong>.',
