 ...
 *
 * Заменяет линейный перебор O(n) на хеш-сетку O(1)平均 при hit-testing.
...
window.MapSpatial = (function () {
     ...
     * Безопасна для экраных координат (typically -2000..5000).
     *
    ...
    /**
     * Быстрый поиск вышки по экраниным координатам.
     * Среднее время O(1) для разреженных вышек (каждая в своей ячейке).
     *
     * @param {number} sx — экраниая X (пиксели)
     * @param {number} sy — экраниая Y (пиксели)
    ...
    /**
     * Возвращает предвычисленную экраниую позицию вышки.
